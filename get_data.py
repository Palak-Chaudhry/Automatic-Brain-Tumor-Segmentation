...
def main():
    ...
    # Dataset paths
    data_read_path = 'D:\Palak\Brain-Tumor-Segmentation\BTS_Palak\dataset'
    data_save_path = os.path.join('D:\Palak\Brain-Tumor-Segmentation\BTS_Palak\dataset', 'png_dataset')
